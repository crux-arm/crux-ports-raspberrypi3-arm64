...
To use these ports, download the `raspberrypi3-arm64.rsync` file to `/etc/ports`:
```
$ sudo wget -P /etc/ports https://git.crux.nu/crux-arm/raspberrypi3-arm/raw/branch/3.8/raspberrypi3-arm64.rsync
